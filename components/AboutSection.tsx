...
export default function AboutSection() {
  ...
  return (
    <>
      ...
      <section id="about" className="relative py-10 sm:py-12 lg:py-14 bg-gradient-to-b from-[#faf9f7] to-white overflow-hidden">
        <div 
          ref={logoRef}
        ...
        >
          <div className="flex flex-col items-center">
            ...
            {/* Tagline */}
            <p className="text-sm sm:text-base text-[#888] font-light tracking-widest uppercase mb-4 sm:mb-5">
              {t('logoTagline')}
            </p>
      ...
      <section className="relative py-16 sm:py-24 lg:py-32 bg-white overflow-hidden">
        <div className="absolute top-0 right-0 w-48 sm:w-96 h-48 sm:h-96 bg-gradient-to-bl from-[#f8f6f3] to-transparent rounded-full opacity-60 -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-32 sm:w-64 h-32 sm:h-64 bg-gradient-to-tr from-[#e8e0d4]/30 to-transparent rounded-full translate-y-1/3 -translate-x-1/4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg lg:text-xl text-[#666666] leading-relaxed mb-8 sm:mb-10">
                {t('decoDescription')}
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="relative">
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="image-hover-zoom rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-2xl bg-white">
                      <Image
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                    <div className="image-hover-zoom rounded-xl sm:rounded-2xl overflow-hidden shadow-md sm:shadow-lg bg-white">
                      <Image
                    ...
                    <div className="image-hover-zoom rounded-xl sm:rounded-2xl overflow-hidden shadow-md sm:shadow-lg bg-white col-span-2 sm:col-span-1">
                      <Image
            ...
            >
              <Image
                ...
                width={160}
                height={64}
                className="mb-6 sm:mb-8 w-[140px] sm:w-[200px]"
              />
              ...
              <p className="text-base sm:text-lg text-[#666666] leading-relaxed mb-8 sm:mb-10">
