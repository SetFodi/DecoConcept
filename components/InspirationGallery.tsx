        ...
        <div className="grid grid-cols-2 md:grid-cols-4 auto-rows-[120px] sm:auto-rows-[160px] md:auto-rows-[200px] gap-2 sm:gap-3 md:gap-4">
          {galleryImages.map((img, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#2d3e36]/80 via-[#2d3e36]/20 to-transparent opacity-0 group-hover:opacity-100 sm:transition-all sm:duration-500" />
