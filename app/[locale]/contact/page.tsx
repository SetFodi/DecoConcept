...
export default function ContactPage() {
  ...
  const whatsappNumber = '995577477288';
      ...
      <section className="relative z-20 -mt-12 sm:-mt-20 pb-12 sm:pb-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div 
              className={`lg:col-span-3 bg-gradient-to-br from-[#2a4556] to-[#1a2820] rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-xl transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
